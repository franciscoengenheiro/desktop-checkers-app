...
// since there is test in TestRow.kt line 61, when comparing object instances, that fails
...
class Column private constructor(val char: Char) {
    ...
    val index get() = char.code - 'a'.code // Example: 0, 1, 2, ...
    val symbol get() = char // Example: a, b, c, ...
